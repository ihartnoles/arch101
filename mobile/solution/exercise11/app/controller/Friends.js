...
Ext.define('FriendsWithBeer.controller.Friends', {
    ...
    onBeerFriendsListActivate: function(container, newActiveItem, oldActiveItem, eOpts) {
        this.calcDistances();
    },
    ...
    onBtnGeoCodeTap: function(button, e, eOpts) {
    ...
    onFriendrandomizerActivate: function(container, newActiveItem, oldActiveItem, eOpts) {
    ...
    onBtnBackToFriendListTap: function(button, e, eOpts) {
        this.onGoToList();
    },
